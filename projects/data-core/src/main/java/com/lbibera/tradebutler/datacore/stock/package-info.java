 ...
 * or rights to ownership as represented by an option. A stock is a fungible,
 * negotiable financial instrument that represents some type of financial value.
 * The company or entity that issues the stock is known as the issuer.
 */
package com.lbibera.tradebutler.datacore.stock;